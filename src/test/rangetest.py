...
#        button.show()
        ...
        item = make_menu_item ("Otsu", self.cb_pos_menu_select, gtk.POS_TOP)
        menu.append(item)
  
        item = make_menu_item ("Niblack", self.cb_pos_menu_select,
                               gtk.POS_BOTTOM)
        menu.append(item)
  
        item = make_menu_item ("Sauvola", self.cb_pos_menu_select, gtk.POS_LEFT)
        menu.append(item)
  
        item = make_menu_item ("Kitler", self.cb_pos_menu_select, gtk.POS_RIGHT)
        menu.append(item)
